...
void I2C_Write_Byte(I2C_HandleTypeDef *i2c, uint8_t address, uint8_t Cmd, uint8_t value);
int I2C_Read_Byte(I2C_HandleTypeDef *i2c, uint8_t address, uint8_t Cmd);
int I2C_Read_Word(I2C_HandleTypeDef *i2c, uint8_t address, uint8_t Cmd);
